...
class _DrawerWidgetState extends State<DrawerWidget> {
  ...
  void _initProviderHandler(BuildContext context) {
    ...
    ReferralRewardOffersProvider.of(context).setReferralRewardOffersState(ReferralRewardOffersState.init(), isNotifiable: false);
    ReferralRewardOffersForStoreProvider.of(context).setReferralRewardOffersForStoreState(
      ReferralRewardOffersForStoreState.init(),
      isNotifiable: false,
    );
