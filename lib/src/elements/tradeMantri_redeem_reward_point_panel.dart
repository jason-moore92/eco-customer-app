...
class TradeMantriRedeemRewardPointPanel extends StatefulWidget {
...
class _RedeemRewardPointPanelState extends State<TradeMantriRedeemRewardPointPanel> {
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  "Would you like to redeem trademantri reward points",
                  style: TextStyle(fontSize: fontSp * 14, color: Colors.black),
                ),
                SizedBox(height: heightDp * 10),
                Text(
                  "Reward Points: ${widget.orderModel!.redeemRewardData == null || widget.orderModel!.redeemRewardData!["tradeRedeemRewardPoint"] == null ? 0 : widget.orderModel!.redeemRewardData!["tradeRedeemRewardPoint"]}",
          ...
          KeicyRaisedButton(
            ...
            onPressed: () async {
              await TradeMantriRedeemDialog.show(
                context,
                widthDp: widthDp,
                heightDp: heightDp,
                fontSp: fontSp,
                ...
                callBack: (int sumRewardPoint, int redeemRewardValue, int redeemRewardPoint) {
                  ...
                  widget.orderModel!.redeemRewardData!["tradeSumRewardPoint"] += sumRewardPoint;
                  widget.orderModel!.redeemRewardData!["tradeRedeemRewardValue"] = redeemRewardValue;
                  widget.orderModel!.redeemRewardData!["tradeRedeemRewardPoint"] = redeemRewardPoint;
