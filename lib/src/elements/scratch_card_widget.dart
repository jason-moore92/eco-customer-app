...
class ScratchCardWidget extends StatefulWidget {
  ...
  ScratchCardWidget({@required this.orderData, @required this.isLoading, @required this.callback});
    ...
    return MultiProvider(
      ...
      child: Consumer<ScratchCardProvider>(builder: (context, scratchCardProvider, _) {
        ...
        if (scratchCardProvider.scratchCardState.scratchCardData!["status"] == "scratched") {
          ...
          widget.orderData!["scratchCard"][0] = scratchCardProvider.scratchCardState.scratchCardData!;
        }

        if (widget.orderData!["scratchCard"][0]["status"] == "scratched") return _winWidget();
              ...
              return Scratcher(
                ...
                onScratchStart: () {
                  if (scratchCardProvider.scratchCardState.progressState == 0) {
                    ...
                    scratchCardProvider.getScratchCard(scratchCardId: widget.orderData!["scratchCardId"]);
                  }
                },
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            "₹ ${widget.orderData!["scratchCard"][0]["amount"]}",
          ...
          SizedBox(height: heightDp * 5),
          Text(
            "${widget.orderData!["scratchCard"][0]["amountInPoints"]} Pts",
            style: TextStyle(fontSize: fontSp * 18, fontWeight: FontWeight.bold),
          ),
        ],
      ),
