        ...
        : Column(
            children: [
              ...
              Container(
                // height: heightDp * 360,
                width: deviceWidth,
                height: categoryList.length - 6 <= 3
                    ? cardHeight + heightDp * 5
                    : categoryList.length - 6 <= 6
                        ? cardHeight * 2 + crossAxisSpacing + heightDp * 5
                        : cardHeight * 3 + crossAxisSpacing * 2 + heightDp * 5,
                alignment: Alignment.center,
                child: GridView.builder(
                  physics: categoryList.length - 6 <= 6 ? NeverScrollableScrollPhysics() : AlwaysScrollableScrollPhysics(),
                  scrollDirection: categoryList.length - 6 <= 6 ? Axis.vertical : Axis.horizontal,
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 3,
                    mainAxisSpacing: mainAxisSpacing,
                    crossAxisSpacing: crossAxisSpacing,
                    childAspectRatio: categoryList.length - 6 <= 6 ? cardWidth / cardHeight : cardHeight / cardWidth,
                  ),
                  padding: EdgeInsets.zero,
                  itemCount: categoryList.length - 6,
                  shrinkWrap: true,
                  itemBuilder: (context, index) {
                    Map<String, dynamic> categoryData = categoryList[6 + index];
