      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: widget.currentTitle != "Home"
              ...
              : GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => SearchLocationPage()));
                  },
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          "${appDataProvider.appDataState.currentLocation == null ? "" : appDataProvider.appDataState.currentLocation!["name"] ?? appDataProvider.appDataState.currentLocation!["address"]}",
