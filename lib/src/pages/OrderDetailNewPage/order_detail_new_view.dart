...
class _OrderDetailViewState extends State<OrderDetailView> {
  ...
  Widget _mainPanel() {
    ...
    print("${_orderModel!.orderId}_${_authProvider!.authState.userModel!.id}_${_authProvider!.authState.userModel!.email}");
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                        ...
                        KeicyRaisedButton(
                          ...
                          onPressed: () async {
                            await ScratchCardDialog.show(
                              context,
                              scratchCardId: _orderModel!.scratchCard![0]["id"],
              ...
              ///
              SizedBox(height: heightDp * 15),
              StoreInfoPanel(storeModel: _orderModel!.storeModel),

              ///
              SizedBox(height: heightDp * 15),
              CartListPanel(orderModel: _orderModel),
              ...
              PaymentDetailPanel(orderModel: _orderModel, padding: EdgeInsets.zero),
  ...
  Widget _acceptOrderActionButtonGroup() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceAround,
      children: [
        if (!_orderModel!.payAtStore! && !_orderModel!.cashOnDelivery!)
          KeicyRaisedButton(
            width: widthDp * 130,
            height: heightDp * 30,
            color: config.Colors().mainColor(1),
