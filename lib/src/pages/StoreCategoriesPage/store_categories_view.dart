...
class _StoreCategoriesViewState extends State<StoreCategoriesView> {
  ...
  void initState() {
    ...
    _storeCategoriesProvider!.setStoreCategoriesState(
      _storeCategoriesProvider!.searchPageState.update(
  ...
  void _getCategoryHandler(String searchKey) {
    _storeCategoriesProvider!.setStoreCategoriesState(_storeCategoriesProvider!.searchPageState.update(progressState: 1));
  ...
  Widget _categoryListPanel() {
    ...
    if (_storeCategoriesProvider!.searchPageState.progressState == 1) {
      loadingStatus = true;
    }

    return ListView.separated(
      itemCount: loadingStatus ? AppConfig.countLimitForList : _storeCategoriesProvider!.searchPageState.categoryList!.length,
      itemBuilder: (context, index) {
        Map<String, dynamic> categoryData = loadingStatus ? Map<String, dynamic>() : _storeCategoriesProvider!.searchPageState.categoryList![index];
