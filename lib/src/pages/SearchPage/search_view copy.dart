...
//     if (_searchProvider!.searchPageState.storeList![_categoryId] == null || _searchProvider!.searchPageState.storeList![_categoryId]!.isEmpty) {
...
//           if (searchProvider.searchPageState.progressState == -1) {
//             return ErrorPage(
//               message: searchProvider.searchPageState.message,
//               callback: () {
//                 if (_searchProvider!.searchPageState.storeList![_categoryId] == null ||
//                     _searchProvider!.searchPageState.storeList![_categoryId]!.isEmpty) {
//                   _searchProvider!.setSearchState(_searchProvider!.searchPageState.update(progressState: 1));
//                   _searchProvider!.getStoreList(
//                     categoryId: _categoryId,
//                     location: _appDataProvider!.appDataState.currentLocation!["location"],
//                     distance: _appDataProvider!.appDataState.distance,
...
//     if (_searchProvider!.searchPageState.progressState == 1) {
//       loadingStatus = true;
//     } else if (_searchProvider!.searchPageState.progressState == -1) {
//       return Padding(
//         padding: EdgeInsets.all(widthDp * 20),
//         child: Center(
//           child: Text(
//             _searchProvider!.searchPageState.message!,
//             style: TextStyle(fontSize: fontSp * 12, color: Colors.transparent),
//           ),
//         ),
//       );
//     } else if (_searchProvider!.searchPageState.progressState == 2) {
//       storeList = _searchProvider!.searchPageState.storeList![_categoryId]!;
//     }
...
//           child: Text(
//             loadingStatus ? "0 Store" : "${storeList.length}/${_searchProvider!.searchPageState.storeMetaData![_categoryId]["totalDocs"]} Stores",
...
//             enablePullDown: true,
//             enablePullUp: (_searchProvider!.searchPageState.storeMetaData![_categoryId] == null ||
//                 _searchProvider!.searchPageState.storeMetaData![_categoryId]["nextPage"] != null),
