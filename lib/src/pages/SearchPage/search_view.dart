...
class _SearchViewState extends State<SearchView> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (_searchProvider!.searchPageState.storeList![_type] == null || _searchProvider!.searchPageState.storeList![_type]!.isEmpty) {
      _searchProvider!.setSearchState(
        _searchProvider!.searchPageState.update(progressState: 1),
        isNotifiable: false,
      );
    }
  ...
  void _searchProviderListener() async {
    try {
      if (_tabController!.index == 0) {
        if (_searchProvider!.searchPageState.progressState == -1) {
          if (_searchProvider!.searchPageState.isStoreRefresh!) {
            _refreshControllerList[_tabController!.index].refreshFailed();
            _searchProvider!.setSearchState(
              _searchProvider!.searchPageState.update(isStoreRefresh: false),
              isNotifiable: false,
            );
          } else {
            _refreshControllerList[_tabController!.index].loadFailed();
          }
        } else if (_searchProvider!.searchPageState.progressState == 2) {
          if (_searchProvider!.searchPageState.isStoreRefresh!) {
      ...
      ///
        ...
        if (_searchProvider!.searchPageState.progressState == -1) {
          if (_searchProvider!.searchPageState.isProductRefresh!) {
            _refreshControllerList[_tabController!.index].refreshFailed();
            _searchProvider!.setSearchState(
              _searchProvider!.searchPageState.update(isProductRefresh: false),
              isNotifiable: false,
            );
          } else {
            _refreshControllerList[_tabController!.index].loadFailed();
      ...
      ///
        ...
        if (_searchProvider!.searchPageState.progressState == -1) {
          if (_searchProvider!.searchPageState.isServiceRefresh!) {
            _refreshControllerList[_tabController!.index].refreshFailed();
            _searchProvider!.setSearchState(
              _searchProvider!.searchPageState.update(isServiceRefresh: false),
              isNotifiable: false,
            );
          } else {
            _refreshControllerList[_tabController!.index].loadFailed();
      ...
      ///
        ...
        if (_searchProvider!.searchPageState.progressState == -1) {
          if (_searchProvider!.searchPageState.isCouponRefresh!) {
            _refreshControllerList[_tabController!.index].refreshFailed();
            _searchProvider!.setSearchState(
              _searchProvider!.searchPageState.update(isCouponRefresh: false),
              isNotifiable: false,
            );
          } else {
            _refreshControllerList[_tabController!.index].loadFailed();
    ...
    if (category == "stores") {
      if ((_searchProvider!.searchPageState.progressState != 1) &&
          (_controller.text.isNotEmpty ||
              _searchProvider!.searchPageState.storeList![_type!] == null ||
              _searchProvider!.searchPageState.storeList![_type!].isEmpty)) {
        Map<String, dynamic> storeList = _searchProvider!.searchPageState.storeList!;
        Map<String, dynamic> storeMetaData = _searchProvider!.searchPageState.storeMetaData!;
        ...
        _searchProvider!.setSearchState(
          _searchProvider!.searchPageState.update(
            progressState: 1,
            storeList: storeList,
      ...
      if ((_searchProvider!.searchPageState.progressState != 1) &&
          (_controller.text.isNotEmpty ||
              _searchProvider!.searchPageState.productList![_type!] == null ||
              _searchProvider!.searchPageState.productList![_type!].isEmpty)) {
        Map<String, dynamic> productList = _searchProvider!.searchPageState.productList!;
        Map<String, dynamic> productMetaData = _searchProvider!.searchPageState.productMetaData!;
      ...
      if ((_searchProvider!.searchPageState.progressState != 1) &&
          (_controller.text.isNotEmpty ||
              _searchProvider!.searchPageState.serviceList![_type!] == null ||
              _searchProvider!.searchPageState.serviceList![_type!].isEmpty)) {
        Map<String, dynamic> serviceList = _searchProvider!.searchPageState.serviceList!;
        Map<String, dynamic> serviceMetaData = _searchProvider!.searchPageState.serviceMetaData!;
      ...
      if ((_searchProvider!.searchPageState.progressState != 1) &&
          (_controller.text.isNotEmpty ||
              _searchProvider!.searchPageState.couponList![_type!] == null ||
              _searchProvider!.searchPageState.couponList![_type!].isEmpty)) {
        Map<String, dynamic> couponList = _searchProvider!.searchPageState.couponList!;
        Map<String, dynamic> couponMetaData = _searchProvider!.searchPageState.couponMetaData!;
  ...
  Widget _itemListPanel() {
    ...
    if (category == "stores") {
      if (_searchProvider!.searchPageState.storeList![_type] != null) {
        itemList = _searchProvider!.searchPageState.storeList![_type];
      }
      if (_searchProvider!.searchPageState.storeMetaData![_type] != null) {
        itemMetaData = _searchProvider!.searchPageState.storeMetaData![_type];
      }

      if (_searchProvider!.searchPageState.storeList![_type] != null) {
        List<dynamic> data = _searchProvider!.searchPageState.storeList![_type];
      ...
      if (_searchProvider!.searchPageState.productList![_type] != null) {
        itemList = _searchProvider!.searchPageState.productList![_type];
      }
      if (_searchProvider!.searchPageState.productMetaData![_type] != null) {
        itemMetaData = _searchProvider!.searchPageState.productMetaData![_type];
      }

      if (_searchProvider!.searchPageState.productList![_type] != null) {
        List<dynamic> data = _searchProvider!.searchPageState.productList![_type];
        itemCount += data.length;
      }
      ...
      if (_searchProvider!.searchPageState.serviceList![_type] != null) {
        itemList = _searchProvider!.searchPageState.serviceList![_type];
      }
      if (_searchProvider!.searchPageState.serviceMetaData![_type] != null) {
        itemMetaData = _searchProvider!.searchPageState.serviceMetaData![_type];
      }

      if (_searchProvider!.searchPageState.serviceList![_type] != null) {
        List<dynamic> data = _searchProvider!.searchPageState.serviceList![_type];
        itemCount += data.length;
      }
      ...
      if (_searchProvider!.searchPageState.couponList![_type] != null) {
        itemList = _searchProvider!.searchPageState.couponList![_type];
      }
      if (_searchProvider!.searchPageState.serviceMetaData![_type] != null) {
        itemMetaData = _searchProvider!.searchPageState.serviceMetaData![_type];
      }
      ...
      if (_searchProvider!.searchPageState.couponList![_type] != null) {
        List<dynamic> data = _searchProvider!.searchPageState.couponList![_type];
        itemCount += data.length;
      }
        ...
        Expanded(
          child: NotificationListener<OverscrollIndicatorNotification>(
            ...
            child: SmartRefresher(
              enablePullDown: true,
              enablePullUp: (itemMetaData["nextPage"] != null && _searchProvider!.searchPageState.progressState != 1),
