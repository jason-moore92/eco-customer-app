...
class OrderModel extends Equatable {
  ...
  factory OrderModel.copy(OrderModel model) {
    ...
    return OrderModel(
      ...
      products: products,
      services: services,
      bogoProducts: model.bogoProducts,
      bogoServices: model.bogoServices,
