...
class DeliveryInfo extends Equatable {
  ...
  factory DeliveryInfo.fromJson(Map<String, dynamic> map) {
    return DeliveryInfo(
      ...
      minAmountForDelivery: map["minAmountForDelivery"] ?? "",
      minAmountForFreeDelivery: map["minAmountForFreeDelivery"] ?? "",
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      "minAmountForDelivery": minAmountForDelivery ?? "",
  ...
  factory DeliveryInfo.copy(DeliveryInfo model) {
    return DeliveryInfo(
      ...
      deliveryPartner: model.deliveryPartner,
