  ...
  static show(
    ...
    void _redeemHandler() async {
      ...
      int redeemRewardPoint = (double.parse(_controller.text) /
              double.parse(_rewardPointProvider!.rewardPointState.rewardPointData!["redeem"]["rewardPoints"].toString()) *
              double.parse(_rewardPointProvider!.rewardPointState.rewardPointData!["redeem"]["rewardPoints"].toString()))
          .toInt();

      int redeemValue = (double.parse(_controller.text) /
              double.parse(_rewardPointProvider!.rewardPointState.rewardPointData!["redeem"]["rewardPoints"].toString()) *
              double.parse(_rewardPointProvider!.rewardPointState.rewardPointData!["redeem"]["value"].toString()))
          .toInt();
              ...
              child: Consumer2<RewardPointHistoryProvider, RewardPointProvider>(
                builder: (context, rewardPointHistoryProvider, rewardPointProvider, _) {
                  ...
                  if (rewardPointHistoryProvider.rewardPointHistoryState.progressState == 0) {
                    rewardPointHistoryProvider.sumRewardPoints(userId: userId, storeId: Environment.rootStoreId);
                  }

                  if (rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId] == null) {
                    rewardPointProvider.getRewardPoint(storeId: Environment.rootStoreId);
                  }
                  ...
                  if (rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId].isEmpty) {
                    return Center(
                      child: Column(
                        children: [
                          Text("There is no TradeMantri Reward Point data", style: TextStyle(fontSize: fontSp! * 18)),
                  ...
                  return Form(
                    ...
                    child: Column(
                      children: [
                        Text(
                          "Total TradeMantri Reward Point",
                        ...
                        Text(
                          "(multiples of "
                          "${rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"]}"
                          " as "
                          "${rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"]}"
                          " reward points = "
                          "${rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["value"]}"
                          " rupee)",
                          ...
                          child: TextFormField(
                            ...
                            validator: (input) {
                              ...
                              var price = double.parse(input) ~/
                                  double.parse(rewardPointProvider
                                      .rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"]
                                      .toString()) *
                                  double.parse(
                                      rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["value"].toString());
                              ...
                              if (double.parse(input) > rewardPointHistoryProvider.rewardPointHistoryState.sumRewardPoint!)
                                ...
                                return "The total value of order is below 0 rupees. You cant place an order like this";
                                  ...
                                  rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"])
                                return "Please enter bigger value then ${rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"]}";
                              else
                                return null;
                            },
                          ),
