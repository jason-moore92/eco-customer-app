            ...
            Widget _winWidget = Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "₹ ${scratchCardProvider.scratchCardState.scratchCardData!["amount"]}",
                  ...
                  SizedBox(height: heightDp * 5),
                  Text(
                    "${scratchCardProvider.scratchCardState.scratchCardData!["amountInPoints"]} Pts",
                    style: TextStyle(fontSize: fontSp * 18, fontWeight: FontWeight.bold),
                  ),
                ],
              ),
            ...
            return SimpleDialog(
              ...
              children: [
                StatefulBuilder(builder: (context, StateSetter setState) {
                  return Scratcher(
                    color:
                        scratchCardProvider.scratchCardState.progressState != 1 && _opacity == 1 ? Colors.transparent : config.Colors().mainColor(1),
