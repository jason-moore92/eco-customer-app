                          ...
                          child: TextFormField(
                            ...
                            validator: (input) {
                              ...
                              var price = double.parse(input) ~/
                                  double.parse(rewardPointProvider.rewardPointState.rewardPointData![storeId]["redeem"]["rewardPoints"].toString()) *
                                  double.parse(rewardPointProvider.rewardPointState.rewardPointData![storeId]["redeem"]["value"].toString());
