      ...
      builder: () {
        return MultiProvider(
          providers: [
            ...
            ChangeNotifierProvider(create: (_) => ReferralRewardOffersProvider()),
            ChangeNotifierProvider(create: (_) => ReferralRewardOffersForStoreProvider()),
          ...
          child: MaterialApp(
            ...
            //   primaryColor: config.Colors().primaryDarkColor(1),
            //   scaffoldBackgroundColor: config.Colors().primaryDarkColor(1),
            //   accentColor: config.Colors().mainDarkColor(1),
            //   hintColor: config.Colors().secondDarkColor(1),
            //   focusColor: config.Colors().accentDarkColor(1),
            //   iconTheme: IconThemeData(color: config.Colors().secondDarkColor(1)),
            //   textTheme: TextTheme(
